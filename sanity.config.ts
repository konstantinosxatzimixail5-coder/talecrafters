      ...
      structure: (S) =>
        S.list()
          ...
          .items([
            ...
            S.divider(),
            S.documentTypeListItem('arsenalCategory').title('Services'),
            S.documentTypeListItem('solution').title('Solution pages'),
            ...
            S.documentTypeListItem('animationStyle').title('Animation styles'),
          ]),
    }),
    visionTool(),
  ],
