...
export const post: Post = {
  ...
  standfirst:
    'MCP is a standard way for a model to use the software a team already runs, with nothing pasted into a chat window. It matters because the expensive part of most creative work is moving information between systems, and that is precisely what a connected model can do without judgement.',
  body: [
    {
      t: 'p',
    ...
    { t: 'h2', text: 'What it does not solve' },
    {
      ...
      items: [
        ...
        'Judgement. The model can now do more, which raises the value of the person deciding what it should do.',
      ],
    },
    {
      t: 'p',
