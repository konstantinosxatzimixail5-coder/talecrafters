...
export const post: Post = {
  ...
  excerpt:
    'Editing was always the craft that made shots into a sequence. It matters more now, because generated shots arrive with almost nothing in common.',
  ...
  body: [
    ...
    { t: 'h2', text: 'The nine rules' },
    {
      ...
      items: [
        ...
        'Let sound run across the cut. Continuous audio over a picture change is the oldest continuity trick there is, and on generative footage it does most of the work.',
        ...
        'Cut fast on the first pass, past the point of comfort, then find where it can breathe. Long holds are where drift becomes visible, and a held shot has to be earned.',
      ],
    },
    ...
    },
    {
      ...
      text: 'Put a disproportionate share of the post budget into sound. Continuous room tone, a consistent music bed and dialogue that runs across picture changes do the heavy lifting on perceived coherence in a generative sequence, at a fraction of what frame-level work costs.',
    },
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'Because continuous audio across a picture change is the oldest continuity device there is, and generated clips share none of the picture-level consistency an editor normally inherits. Room tone, a consistent bed and dialogue running across cuts buy the most perceived coherence per pound available on the job.',
    },
    {
