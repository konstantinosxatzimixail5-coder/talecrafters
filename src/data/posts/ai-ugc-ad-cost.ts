...
export const post: Post = {
  ...
  body: [
    ...
    {
      t: 'p',
      text: 'The shape is the point. In traditional UGC the shoot dominates; in synthetic UGC there is no shoot, so what remains is writing and rights, plus the judgement. Three things that do not get cheaper with volume, which is why the per-asset cost stops falling much past a certain batch size.',
    },
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'Because what remains after the shoot is removed is writing and rights, plus the judgement to tell them apart, and none of those get much cheaper with volume. Generation scales; the three things around it do not.',
    },
  ],
