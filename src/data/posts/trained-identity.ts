...
export const post: Post = {
  ...
  standfirst:
    'There are three practical ways to hold a face steady across generative output, and choosing wrongly costs you either a lot of setup you did not need or a lot of regeneration you could have avoided. The deciding variable is asset count, and the threshold sits at around twenty.',
  body: [
    {
      t: 'p',
